  ...
  return (
    <section className="bg-gray-50 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        {/* Intro */}
        <p className="max-w-3xl mx-auto text-center text-lg md:text-xl text-gray-600 leading-relaxed mb-16">
          Welcome to all{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {/* Mission */}
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
